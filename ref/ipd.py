...
vertex_scale = 0.001
# object info
objects = [str(i) for i in [0,1,4,8,10,11,14,18,19]]
id2obj = {i: str(i) for i in [0,1,4,8,10,11,14,18,19]}
...
zNear = 0.25
zFar = 6.0
camera_matrix = np.array([[3981.985991142684, 0.0, 1954.1872863769531], [0.0, 3981.985991142684, 1103.6978149414062], [0, 0, 1]])
zNear = 0.25
zFar = 6.0
...
# ref core/gdrn_modeling/tools/ipd/ipd_1_compute_fps.py
def get_fps_points():
...
# ref core/roi_pvnet/tools/ipd/ipd_1_compute_keypoints_3d.py
