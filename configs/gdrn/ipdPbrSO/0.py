...
OUTPUT_DIR = "output/gdrn/ipdPbrSO/0"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=True,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    TRAIN=("ipd_0_train_pbr",),
    TEST=("ipd_bop_test",),
    DET_FILES_TEST=("datasets/BOP_DATASETS/ipd/test/test_bboxes/yolox_x_640_ipd_pbr_ipd_bop_test.json",),
...
VAL = dict(
    ...
    SAVE_BOP_CSV_ONLY=True,  # NOTE: for ipd_test, no gt
)
